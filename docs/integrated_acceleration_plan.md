...
- ⬜ **Week 3b**:雙 GPU Qwen Pool + GPU Capacity Manager(`BudgetGate`)
...
*文件最後更新:2026-06-02(Week 3a Dynamic Batching + 音訊 Stage 全拆完成;Week 2c 標記完成;BatchCollector 架構與有效批量說明補全)*
