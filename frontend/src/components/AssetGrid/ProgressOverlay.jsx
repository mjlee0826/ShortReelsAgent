 ...
 * total 為 0 時不顯示百分比（避免除以零），改顯示準備中提示。
 */
export default function ProgressOverlay({ visible, done, total }) {
  ...
  return (
    <div className="mb-5 px-4 py-3 bg-accent-soft border border-accent/30 rounded-xl">
      <div className="flex items-center justify-between mb-2 text-xs text-accent-ink">
        <span>正在分析素材...</span>
