...
class PromptFactory:
    """純粹的路由工廠：把 TaskMode 映射到 PromptManager 對應的提示詞方法，回傳 PromptSpec。"""

    @staticmethod
    def create_prompt(mode: TaskMode, manager: BasePromptManager, **kwargs) -> PromptSpec:
        """依 mode 取對應提示詞方法並執行，回傳含文字與選填 schema 的 PromptSpec。"""
        # TaskMode → 對應的提示詞產生方法
        prompt_map = {
